(() => {
    ...
    (() => {
        ...
        var SimpleBarCore = function() {
            ...
            SimpleBarCore.prototype.initDOM = function() {
                ...
                if (!this.options.autoHide) {
                    null === (_d = this.axis.x.scrollbar.el) || void 0 === _d ? void 0 : _d.classList.add(this.classNames.visible);
                    null === (_e = this.axis.y.scrollbar.el) || void 0 === _e ? void 0 : _e.classList.add(this.classNames.visible);
                }
        ...
        da.init();
        var datepicker_min = __webpack_require__(801);
        window.addEventListener("load", (function(e) {
            datepicker_min("[data-calendar]", {});
            const events = document.querySelector(".events__items_more");
            const more = document.querySelector(".events__button");
            const hide = document.querySelector(".events__button_hidden");
            const blog = document.querySelector(".blog__items_more");
            const blogmore = document.querySelector(".blog__button");
            const bloghide = document.querySelector(".blog__button_hidden");
            ...
            blogmore.addEventListener("click", (function(e) {
                blogmore.classList.add("active");
                blog.style.display = "flex";
                bloghide.style.display = "block";
            }));
            bloghide.addEventListener("click", (function(e) {
                blogmore.classList.remove("active");
